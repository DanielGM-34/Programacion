...
public class Juego implements Comparable<Juego> {
	...
	public String toString() {
		return titulo + " (" + genero + ", " + añoPublicacion + ") - Descargas: " + numDescargas + " - Estado: "
				+ estado;
	}

	@Override
	public int compareTo(Juego o) {
		int comparar = this.getTitulo().compareTo(o.getTitulo());
		if (comparar == 0) {
			comparar = this.getAñoPublicacion().compareTo(o.getAñoPublicacion());
		}
		return comparar;
	}
}
