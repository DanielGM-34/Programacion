...
import ExamenSorayaPOOOO.MiembroBase;
import ExamenSorayaPOOOO.MiembroEstandar;
import ExamenSorayaPOOOO.MiembroPremium;
...
public class MiembrosLista {
	...
	protected MiembrosLista[] amigos;

	public MiembrosLista(int id, String email, String nombre) {
			super();
			this.id = contador+1;
			this.email = email;
			this.nombre = nombre;
	...
	public static void setContador(int contador) {
		MiembrosLista.contador = contador;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MiembrosLista other = (MiembrosLista) obj;
	...
	/*
	public boolean isAmigo(MiembrosLista a) {
		int tamanyoMax = 0;
